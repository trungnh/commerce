		...
		public function setup() {
			...
			add_theme_support(
				'custom-logo', apply_filters(
					'shoptimizer_custom_logo_args', array(
						'height'      => 110,
						'width'       => 470,
						'flex-height' => true,
						'flex-width'  => true,
			...
			register_nav_menus(
				apply_filters(
					'shoptimizer_register_nav_menus', array(
			...
			add_theme_support(
				'site-logo', apply_filters(
					'shoptimizer_site_logo_args', array(
						'size' => 'full',
					)
				)
			);
			...
			add_theme_support(
				'woocommerce', apply_filters(
					'shoptimizer_woocommerce_args', array(
