			...
			<div class="inside">
				<table class="form-table admin-order-bump" role="presentation">
					...
					<tr class="product-ids" style="display:none;">
						...
						<td> <label><select name="commercekit_obp_pdt_pids[]" class="select2" data-type="all" multiple="multiple" style="width:100%;"></select><input type="hidden" name="commercekit[order_bump_product][product][pids][]" class="select3 text" value="" /></label></td> 
					</tr>
