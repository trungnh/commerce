...
[https://preview.wp-meteor.com/](https://preview.wp-meteor.com/). 
...
Use `wpmeteor_enabled` filter and return false to completely disable WP Meteor, see [Issue](https://wordpress.org/support/topic/exclude-a-script-from-lazy-load/) for an example
