...
jQuery(document).ready(function(){
	...
	jQuery('body').on('change', '#commercekit_inventory_display, #commercekit_ajax_search, #commercekit_waitlist, #commercekit_wishlist, #commercekit_countdown_timer, #commercekit_order_bump, #commercekit_pdp_triggers', function(){
		if( jQuery(this).prop('checked') )
