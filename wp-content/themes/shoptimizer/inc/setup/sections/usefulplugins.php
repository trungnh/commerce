	...
	<div class="ccfw-tab-pane-center">
		...
		<table class="useful-table">
			...
			<tbody>
				...
				<tr>
					<td>
						<h3><?php esc_html_e( 'YITH Wishlist', 'shoptimizer' ); ?></h3>
						<p><?php esc_html_e( 'Allow users to add items to a wishlist page.', 'shoptimizer' ); ?></p>
					</td>
					<td class="link">
						<a class="button-primary" target="_blank" href="<?php echo esc_url( 'https://wordpress.org/plugins/yith-woocommerce-wishlist/' ); ?>"><?php esc_html_e( 'More information', 'shoptimizer' ); ?></a>
					</td>
				</tr>
