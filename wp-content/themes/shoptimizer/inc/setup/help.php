...
//		add_action( 'shoptimizer_help', array( $this, 'shoptimizer_help_usefulplugins' ), 20 );
	...
	public function shoptimizer_welcome_admin_notice() {
		...
		<div class="updated notice is-dismissible">
			<p><?php echo sprintf( esc_html__( 'Thanks for choosing Shoptimizer! You can read hints and tips on how get the most out of your new theme in the %1$sHelp Centre%2$s.', 'shoptimizer' ), '<a href="' . esc_url( admin_url( 'themes.php?page=ccfw-help' ) ) . '">', '</a>' ); ?></p>
	...
	public function shoptimizer_help_screen() {
		...
		<div class="ccfw-help container">
			...
			<h1 class="ccfw-help-title"><?php esc_html_e( 'Shoptimizer Help Centre', 'shoptimizer' ); ?></h1>
